...
import torch
import numpy as np
from evaluation.constants import MATTERPORT_LABELS, SCANNET_LABELS, SCANNETPP_LABELS, REPLICA_LABELS
...
extract_text_feature('data/text_features/replica.npy', REPLICA_LABELS)