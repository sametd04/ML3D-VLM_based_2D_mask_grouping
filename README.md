...
2. From the repo root, run the one-shot setup: `bash setup_env.sh`. This creates the `maskclustering` conda env and installs everything (PyTorch, pytorch3d, detectron2, CropFormer, and the rest of `requirements.txt`).
