...
# ---------- Label info ---------- #
from evaluation.constants import MATTERPORT_LABELS, MATTERPORT_IDS, SCANNET_LABELS, SCANNET_IDS, SCANNETPP_LABELS, SCANNETPP_IDS, REPLICA_LABELS, REPLICA_IDS
...
if opt.dataset == 'matterport3d':
    ...
    CLASS_LABELS = REPLICA_LABELS
    VALID_CLASS_IDS = REPLICA_IDS
